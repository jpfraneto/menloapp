...
struct FirstRunView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("Describe an app or a change here. Menlo sends your intent to this Mac, which builds and signs the app for your iPhone. Finish connecting once to get started.")
                .font(.system(size: 16))
