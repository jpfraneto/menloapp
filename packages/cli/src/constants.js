export const NPM_CLI_VERSION = "1.3.1";
export const PRODUCT_VERSION = "1.3.0";
export const MANIFEST_URL = "https://tohseno.com/releases/cli-1.3.0.json";
...
export const RELEASE_LAYOUT = "tohseno-user-release/2";
